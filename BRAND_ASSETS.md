# MeaningNonce brand assets

## Logo concept

The mark combines a stylized `M` and `N` inside concentric semantic-boundary rings. The crossed diagonal lines represent reworded attempts hitting the same meaning boundary, while the shield-like outer silhouette communicates enforcement rather than generic AI judgment.

Core visual idea: **different wording, same semantic boundary**.

## Palette

- Midnight: `#080A12`
- Panel navy: `#0E111B`
- Semantic purple: `#9B6CFF`
- Verdict pink: `#EF68BB`
- Verified green: `#43D483`
